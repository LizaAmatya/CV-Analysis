...
class EventForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if request_user.role == 'ADMIN' or request_user.is_superuser:
            ...
            # self.fields['job_title'].required = Event.objects.all()
            self.fields['skill'].required = Event.objects.all()
            self.fields['education'].required = Event.objects.all()
            self.fields['experience'].required = Event.objects.all()
    ...
    class Meta:
        model = Event
        fields = (
            'name', 'event_type', 'skill', 'education', 'experience', 'contacts', 'assigned_to', 'start_date', 'start_time',
